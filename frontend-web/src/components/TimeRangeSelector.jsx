  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 md:px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full sm:w-auto min-w-[120px] md:min-w-[200px]"
      >
      ...
      {showDropdown && (
        <>
          ...
          <div className="absolute left-0 sm:right-0 mt-2 w-full sm:w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-20">
